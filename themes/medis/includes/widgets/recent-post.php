...
class MyTheme_Recent_Post_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => esc_html__( 'Hiển thị bài viết mới nhất', 'medis' ),
		);
	...
	function form( $instance ): void {
		$defaults = array(
			'title' => esc_html__('Bài viết mới nhất', 'medis'),
			'order' => 'DESC'
		);
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'select_cat' ) ); ?>">
				<?php esc_attr_e( 'Chọn danh mục:', 'medis' ); ?>
            </label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'order_by' ) ); ?>">
				<?php esc_html_e( 'Sắp xếp theo:', 'medis' ); ?>
            </label>
            ...
            <select id="<?php echo esc_attr( $this->get_field_id( 'order_by' ) ); ?>"
                ...
                <option value="rand" <?php echo ( $order_by == 'rand' ) ? 'selected' : ''; ?>>
					<?php esc_html_e( 'Ngẫu nhiên', 'medis' ); ?>
                </option>
            </select>
        </p>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>">
				<?php esc_html_e( 'Số lượng bài viết hiển thị:', 'medis' ); ?>
            </label>
...
// Register widget
function medis_register_recent_post_widget(): void {
	register_widget( 'MyTheme_Recent_Post_Widget' );
}

add_action( 'widgets_init', 'medis_register_recent_post_widget' );
...
class TeamCarousel extends Widget_Base
{
    ...
    {
        return 'es-team-carousel';
    }

    // widget title
    public function get_title(): string
    {
        return esc_html__('Đội ngũ', 'extend-site');
    }
    ...
    {
        return ['team', 'slider', 'carousel', 'extend site'];
    }
    ...
    protected function render(): void
    {
        ...
        $classes = ['es-addon-team-carousel es-slider-wrap es-slider-wrap--carousel'];
